...
class ProductsPage extends BasePage {
	...
	async verifyProductsPageTitleVisible() {
		return await this.isElementVisible(landingPageTitle, testData.notVisibleText)
	}

	async verifyPeekImage() {
		return await this.isElementVisible(landingPageImage, testData.notVisibleText)
	}
	...
	async burgerCrossButtonVisible() {
		return await this.isElementVisible(burgerCrossButton, testData.notVisibleText)
	}
	...
	async allItemsSideBarLink() {
		return await this.isElementVisible(allItemsSideBarLink, testData.notVisibleText)
	}

	async aboutSideBarLink() {
		return await this.isElementVisible(aboutSideBarLink, testData.notVisibleText)
	}
	...
	async resetSideBarLink() {
		return await this.isElementVisible(resetSideBarLink, testData.notVisibleText)
	}
	...
	async shoppingCartCountAsTwo() {
		return await this.verifyElementText(shoppingCartLink, testData.cartCountAsTwo)
	}
	...
	async productSortContainerVisible() {
		return await this.isElementVisible(productSortContainer, testData.notVisibleText)
	}

	async selectZAFromDropDown() {
		return await this.selectValueFromDropdown(productSortContainer, testData.optionZA)
	}
	...
	async inventoryContainerVisible() {
		return await this.isElementVisible(inventoryContainer, testData.notVisibleText)
	}
	...
	async addToCartButtonIsEnabled() {
		return await this.isElementVisible(backPackAddToCartBtn, testData.notEnabledText)
