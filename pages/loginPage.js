...
class LoginPage extends BasePage {
	...
	async botImageVisible() {
		return await this.isElementEnabled(loginPageBotImage, testData.notVisibleText)

	}

	async loginCredentialsVisible() {
		return await this.isElementEnabled(loginCredentials, testData.notVisibleText)
